@echo off
REM PKI X.509 Lab - Git Setup Script
REM This script initializes git and creates 8 meaningful commits

cd /d %~dp0

echo ========================================
echo PKI X.509 Lab - Git Repository Setup
echo ========================================
echo.

REM Step 0: Initialize git repository
echo [1/9] Initializing git repository...
git init
git config user.name "Your Name"
git config user.email "your.email@example.com"
echo.

REM Step 1: Initial commit - Core infrastructure
echo [2/9] Commit 1: Core infrastructure and utilities...
git add pki_lab.py
...
REM Step 2: CA creation feature
echo [3/9] Commit 2: Implement Certificate Authority creation...
git add pki_lab.py
...
REM Step 3: CSR generation
echo [4/9] Commit 3: Add Certificate Signing Request (CSR) generation...
git add pki_lab.py
...
REM Step 4: RA approval workflow
echo [5/9] Commit 4: Implement Registration Authority approval workflow...
git add pki_lab.py
...
REM Step 5: Certificate signing
echo [6/9] Commit 5: Add CA certificate signing functionality...
git add pki_lab.py
...
REM Step 6: Extended Key Usage and SAN handling
echo [7/9] Commit 6: Add Extended Key Usage and certificate features...
git add pki_lab.py
...
REM Step 7: Certificate revocation and CRL
echo [8/9] Commit 7: Add certificate revocation and CRL management...
git add pki_lab.py
git commit -m "feat: implement certificate revocation and CRL generation
...
REM Step 8: Documentation and configuration
echo [9/9] Commit 8: Add comprehensive documentation...
...
echo ========================================
echo.
echo Your repository now contains 8 meaningful commits:
echo   1. Initial project structure with core infrastructure
echo   2. Certificate Authority creation
echo   3. Certificate Signing Request generation
echo   4. Registration Authority approval workflow
echo   5. CA certificate signing functionality
echo   6. Extended Key Usage and certificate features
echo   7. Certificate revocation and CRL management
echo   8. Documentation and configuration
echo.
...
echo.
echo All commits will be pushed at once!
echo ========================================
